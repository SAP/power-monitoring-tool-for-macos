...
/*!
 @class         MTCO2SignalAPI
 @abstract      This class provides methods to retrieve carbon data using the CO2Signal API (https://www.co2signal.com).
*/

@interface MTCO2SignalAPI : NSObject
...
/*!
 ...
 @abstract      Initialize a MTCO2SignalAPI object with the given API key.
 @param         key The API key..
 @discussion    Returns an initialized MTCO2SignalAPI object.
*/
